...
public class AtomStructureMemento {
   ...
   * @param tracks tracks
   * @param numTracks num Tracks
   * @throws ClassNotFoundException exception
   * @throws IOException exception
   */

  public AtomStructureMemento(Map<Track, ArrayList<Electron>> rel, 
      List<Electron> objects, List<Track> tracks,
      int numTracks) throws ClassNotFoundException, IOException {
  ...
  public void setRel(Map<Track, ArrayList<Electron>> rel) 
  ...
  private List<Track> deepCopyTrackList(List<Track> src) 
  ...
  private List<Electron> deepCopyObjectList(List<Electron> src) 
      throws IOException, ClassNotFoundException {
    ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
    ObjectOutputStream out = new ObjectOutputStream(byteOut);
    out.writeObject(src);
  ...
  private Map<Track, ArrayList<Electron>> deepCopyMap(Map<Track, ArrayList<Electron>> src)
      throws IOException, ClassNotFoundException {
    ByteArrayOutputStream byteOut = new ByteArrayOutputStream();
    ObjectOutputStream out = new ObjectOutputStream(byteOut);
    out.writeObject(src);

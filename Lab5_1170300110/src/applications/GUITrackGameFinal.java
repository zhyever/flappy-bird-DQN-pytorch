...
public class GuiTrackGameFinal {
  ...
  private void initialize() {
    ...
    textArea.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 12));
    ...
    changeAthName2.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    newTrackNumLabel.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    delTrackNum.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonShowGraph.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonChangeAth.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        if (ath1 == null || ath2 == null) {
          // ƒ⁄»› //±ÍÃ‚
          LogTest.logger.error("–¬‘ˆ‘À∂Ø‘± ‰»Î¥ÌŒÛ");
    ...
    buttonChangeAth.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonAddTrack.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        if (trackNum <= client.game.tracks.size()) {
          LogTest.logger.error("–¬‘ˆπÏµ¿ ‰»Î¥ÌŒÛ");
          JOptionPane.showMessageDialog(frmTrackgame, 
              "Input Error", "Error", JOptionPane.WARNING_MESSAGE);
          newTrackNum.setText("");
        } else {
    ...
    buttonAddTrack.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonDelTrack.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        if (flag) {
          ...
          LogTest.logger.error("…æ≥˝πÏµ¿ ‰»Î¥ÌŒÛ");
          JOptionPane.showMessageDialog(frmTrackgame, 
              "Input Error", "Error", JOptionPane.WARNING_MESSAGE);
          delTrackNum.setText("");
        }
    ...
    buttonDelTrack.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonAddAth.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        if (flag) {
          ...
          LogTest.logger.error("ÃÌº”‘À∂Ø‘± ‰»Î–≈œ¢¥ÌŒÛ");
          JOptionPane.showMessageDialog(frmTrackgame, 
              "Input Error", "Error", JOptionPane.WARNING_MESSAGE);
          name.setText("");
          number.setText("");
    ...
    buttonAddAth.setFont(new Font("Œ¢»Ì—≈∫⁄", Font.PLAIN, 15));
    ...
    buttonDelAth.addMouseListener(new MouseAdapter() {
      ...
      public void mouseClicked(MouseEvent e) {
        ...
        if (flag) {
          ...
          //
          LogTest.logger.info("…æ≥˝" + str);

          delAth.setText("");
        } else {
          LogTest.logger.error("…æ≥˝‘À∂Ø‘± ‰»Î–≈œ¢¥ÌŒÛ");
          JOptionPane.showMessageDialog(frmTrackgame,
              "Input Error", "Error", JOptionPane.WARNING_MESSAGE);
          delAth.setText("");
        }

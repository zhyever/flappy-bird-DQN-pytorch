...
class MyPanel extends JPanel {
  ...
  public void paint(Graphics g) {
    ...
    if (system instanceof TrackGame) {
      Collections.sort(system.tracks, new Comparator<Track>() {
        ...
        public int compare(Track o1, Track o2) {
          int num1 = o1.getNum() * 100;
          int num2 = o2.getNum() * 100;
    ...
    if (system instanceof SocialNetworkCircle) {
      // 遍历图
      Iterator<Map.Entry<People, List<People>>> iterator = ((
          SocialNetworkCircle) system).relation.entrySet()
          .iterator();
      while (iterator.hasNext()) {
        ...
        for (int i = 0; i < it.getValue().size(); i++) {
          ...
          Iterator<Map.Entry<Track, ArrayList<People>>> iterator1 =
              ((SocialNetworkCircle) system).rel.entrySet()
              .iterator();

...
public class ExtractTest {
    ...
    private static final Tweet tweet3 = new Tweet(1, "alyssa", "@lzy: @hit.com @lc-12138 @Lzy @lc_123 @LZY", d3);
    private static final Tweet tweet4 = new Tweet(2, "bbitdiddle", "@hit.com @OBM: @av.ads rivest talk in 30 minutes #hype", d4);
    ...
    public void testSomething() {
        ...
        assertEquals(name, mentionedUsers);
    }
}
